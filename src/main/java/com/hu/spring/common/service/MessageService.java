package com.hu.spring.common.service;

import com.alibaba.fastjson.JSON;
import com.hu.spring.client.ClientInit;
import com.hu.spring.common.event.AbstractEvent;
import com.hu.spring.common.event.EventInterface;
import com.hu.spring.common.pojo.*;
...
public class MessageService {
     ...
     * @throws Exception
     */
    public void handle(WebSocketSession session, String message) throws Exception {
        // 处理消息
     ...
     * @param msg
     */
    public void sendMessage(WebSocketSession session, String msg, String msgType) {
     ...
     * @param result
     */
    public void sendMessage(WebSocketSession session, Result result) {
